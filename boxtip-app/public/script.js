...
$("#btn-query").click(function(){
    ...
    if (validationField1 && validationField2){
        $(".data-row").each(function(){
            let data1 = $(this).find("td[data-column='"+ field1 +"']").text().replace(/\W/g, '').toLowerCase();
            let data2 = $(this).find("td[data-column='"+ field2 +"']").text().replace(/\W/g, '').toLowerCase();
            if (data1.includes(fieldInput1.toLowerCase()) && data2.includes(fieldInput2.toLowerCase())){
...
$("#filter-field-1").change(function(){
    ...
    $("#filter-field-2").val("-1");
    $("#filter-field-2").children().each(function(){
        $(this).removeClass("d-none");
